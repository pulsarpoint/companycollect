...
- Access note: the files are now distributed via Receita's **SERPRO+ portal** (a
  JavaScript app), which made the bulk ZIPs not directly fetchable in this headless
  run — but the data remains **open and free**.
