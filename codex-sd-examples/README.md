...
[`corpscout/services/crawler_service`](../corpscout/services/crawler_service).
This directory retains the earlier examples and experiment labs.

The crawler also runs as a [local service](../corpscout/services/crawler_service/SERVICE.md), accepting
...
recovery. Service setup and its dependency lock live inside `../corpscout/services/crawler_service/`.

The current package separates [HTML crawling and LLM analysis](../corpscout/services/crawler_service/CRAWL_AND_ANALYZE.md):
`crawler-service-crawl` saves a local capture folder; `crawler-service-pages --crawl`
...
The combined [crawler_service package](../corpscout/services/crawler_service/README.md) accepts a URL
...
Install it separately with `pip install -e ../corpscout/services/crawler_service`.
