...
```sh
.venv/bin/python company_research/benchmarks/fresh_company_statements.py \
  --output company_research/data/fresh-company-statements-v1 \
  --catalog company_research/data/novelic-page-statements-v2-validated/technology-catalog.json \
