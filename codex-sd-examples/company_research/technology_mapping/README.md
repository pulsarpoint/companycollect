...
```sh
.venv/bin/python company_research/technology_mapping/audit.py \
  --catalog company_research/data/technology-mapping-audit/catalog.json

.venv/bin/python -m unittest discover \
  -s company_research/technology_mapping -p 'test_*.py' -v

uvx --offline ruff check company_research/technology_mapping
uvx --offline ty check company_research/technology_mapping --python .venv/bin/python
```
