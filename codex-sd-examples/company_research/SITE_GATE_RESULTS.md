...
Reproduce from `codex-sd-examples` with a new output directory:

```sh
.venv/bin/python company_research/benchmarks/site_gate.py \
  --output company_research/data/site-gate-new \
  --replay company_research/data/site-gate-20260916-v1
```
