...
```sh
.venv/bin/python company_research/benchmarks/review_page_statements.py --help
.venv/bin/python company_research/benchmarks/finish_statement_reviews.py --help
```
