...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--source",
        type=Path,
        default=Path("company_research/data/mcap-multiple-relationships-v013"),
    )
    parser.add_argument(
        "--catalog",
        type=Path,
        default=Path(
            "company_research/data/fresh-company-statements-v1/technology-catalog.json"
        ),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("company_research/data/deepseek-direct-20260910-job"),
    )
