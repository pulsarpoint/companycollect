...
```sh
.venv/bin/python company_research/benchmarks/replay_attribution_failures.py
.venv/bin/python company_research/benchmarks/audit_attribution_replay.py \
  company_research/data/attribution-replay-v0141
```
...
```sh
.venv/bin/python company_research/benchmarks/recover_attribution_corrections.py \
...
.venv/bin/python company_research/benchmarks/audit_attribution_recoveries.py
```
