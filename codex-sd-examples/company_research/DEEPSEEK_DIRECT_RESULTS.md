...
Run from `companycollect/codex-sd-examples`. Output directories must be new:

```sh
.venv/bin/python company_research/benchmarks/compare_deepseek_direct.py \
  --env-file jobs_extraction_lab/.env \
  --output company_research/data/deepseek-direct-repeat

.venv/bin/python company_research/benchmarks/compare_deepseek_job_page.py \
  --env-file jobs_extraction_lab/.env \
  --output company_research/data/deepseek-job-repeat
.venv/bin/python company_research/benchmarks/audit_deepseek_job_page.py \
  company_research/data/deepseek-job-repeat
```
