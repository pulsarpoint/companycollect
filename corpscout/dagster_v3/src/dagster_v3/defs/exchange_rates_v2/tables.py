...
EXCHANGE_RATES_V2_DUCKDB_CONTRACT = DuckDBTableContract(
    columns=(
...
EXCHANGE_RATES_V2_DUCKDB_COLUMN_TYPES = EXCHANGE_RATES_V2_DUCKDB_CONTRACT.column_types
