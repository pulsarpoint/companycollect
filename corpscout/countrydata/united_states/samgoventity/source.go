...
var _ countryimport.BulkSource[SamEntityRecord] = (*Source)(nil)
...
type Source struct {
	...
	StoreFunc      func(context.Context, []SamEntityRecord) (countryimport.StoreResult, error)
}
...
func NewSource(cfg Config) *Source {
	...
	if strings.TrimSpace(cfg.SamRegistered) == "" {
		cfg.SamRegistered = DefaultSamRegistered
	}
