...
-- Reverts 000327: restores the view to 000325's original rendering, where `postal_box`
-- is NOT eligible for the coarse centroid fallback (only `unmatched`/`ambiguous` are).
