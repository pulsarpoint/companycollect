...
-- Swaps the retired overlay-reading view back under the serving name, restarts its refresh
-- loop (the up-file stopped it), and discards the address-entity render. Only meaningful
-- while _retired still exists -- after the follow-up drop, roll forward instead.
RENAME TABLE
