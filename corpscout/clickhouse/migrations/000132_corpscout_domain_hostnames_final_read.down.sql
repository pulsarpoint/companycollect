...
-- Restore the grouped state finalization introduced by migration 131. This remains correct but is
-- more expensive for unbounded inventory queries because it builds a high-cardinality hash table.
