...
ALTER TABLE corpscout.no_companies ADD COLUMN IF NOT EXISTS legal_form_description_language Nullable(String);
ALTER TABLE corpscout.no_companies ADD COLUMN IF NOT EXISTS legal_form_description_en Nullable(String);
ALTER TABLE corpscout.no_companies ADD COLUMN IF NOT EXISTS legal_form_description_translated_at Nullable(DateTime64(3, 'UTC'));
ALTER TABLE corpscout.no_companies ADD COLUMN IF NOT EXISTS legal_form_description_translation_provider Nullable(String);
ALTER TABLE corpscout.no_companies ADD COLUMN IF NOT EXISTS legal_form_description_translation_model Nullable(String);
