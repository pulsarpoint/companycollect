...
CREATE TABLE IF NOT EXISTS corpscout.br_cvm_dfp_documents
(
...
CREATE TABLE IF NOT EXISTS corpscout.br_cvm_dfp_statement_rows
(
    country_iso2 LowCardinality(String),
    source_slug LowCardinality(String),
    source_run_id String,
...
CREATE TABLE IF NOT EXISTS corpscout.br_cvm_dfp_capital_composition
(
    country_iso2 LowCardinality(String),
    source_slug LowCardinality(String),
    source_run_id String,
    ...
    ordinary_shares_treasury UInt64,
    preferred_shares_treasury UInt64,
    total_shares_treasury UInt64,
    source_archive_key String,
    source_file_name LowCardinality(String),
    source_row_number UInt64,
    resolved_at DateTime64(3, 'UTC')
...
CREATE TABLE IF NOT EXISTS corpscout.br_cvm_dfp_auditor_reports
(
    country_iso2 LowCardinality(String),
    source_slug LowCardinality(String),
    source_run_id String,
