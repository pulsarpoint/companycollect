...
DROP TABLE IF EXISTS corpscout.se_company_brave_domains_history;

CREATE OR REPLACE VIEW corpscout.se_company_brave_domains_history SQL SECURITY INVOKER AS
