...
-- One row per Swedish company, instrument, and trading venue. FIRDS owns
-- current venue status, GLEIF registered_as resolves the issuer LEI to the
-- Swedish organisation number, and EODHD contributes optional ticker evidence.
