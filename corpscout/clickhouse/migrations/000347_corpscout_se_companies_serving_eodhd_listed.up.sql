...
-- Switches is_publicly_traded from the ESEF-filing signal to the EODHD listings resolve
-- (corpscout.company_traded_symbols, the company_markets module's daily FIRDS+GLEIF+EODHD
-- join): market truth incl. First North/NGM/Spotlight listings that never file ESEF -- 826 SE
