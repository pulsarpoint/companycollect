...
-- Faithful recreate of the pre-market-flags serving render (000338's embedded SELECT,
-- preserved verbatim) under the _retired name, refresh STOPPED as 000344 left it. Roll
-- forward is still the sane path -- this exists so the ledger can walk backwards. The guard
