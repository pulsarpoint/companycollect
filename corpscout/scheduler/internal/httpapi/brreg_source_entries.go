...
func brregSourceEntryListParamsFromRequest(r *http.Request) db.ListBrregSourceEntriesParams {
	...
	return db.ListBrregSourceEntriesParams{
		...
		FinancialStatus:    brregSourceEntryFinancialStatus(r.URL.Query().Get("financial_status")),
...
func brregSourceEntryFinancialStatus(value string) *string {
	switch value {
	case "success", "unknown", "skipped":
		return &value
	default:
		return nil
	}
