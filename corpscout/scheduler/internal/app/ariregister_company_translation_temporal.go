...
func registerAriregisterCompanyTranslationWorker(worker temporalworker.Worker, resources *temporalWorkerResources) {
	...
	worker.RegisterActivityWithOptions(
		resources.ariregisterCompanyTranslation.RefreshAriregisterTranslationStatus,
	...
	worker.RegisterActivityWithOptions(
		resources.ariregisterCompanyTranslation.GetAriregisterTranslationQueueStatus,
		activity.RegisterOptions{Name: "GetAriregisterTranslationQueueStatus"},
	)
}
