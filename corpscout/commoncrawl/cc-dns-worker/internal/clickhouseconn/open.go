// Package clickhouseconn opens ClickHouse connections from the worker's environment.
...
// Open connects using the CLICKHOUSE_* variables shared by both scanner packages.
