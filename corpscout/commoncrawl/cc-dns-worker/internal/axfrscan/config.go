...
//
// It reads the latest DNS delegation summaries from ClickHouse and owns a separate SQLite queue,
// probe pool, ClickHouse outbox, and statistics. It neither imports nor coordinates with dnsscan.
package axfrscan
