...
ORDER BY
  ...
  CASE WHEN sqlc.arg('sort_by')::text = 'synced' AND sqlc.arg('sort_dir')::text = 'asc' THEN ri.sync_status END ASC,
  CASE WHEN sqlc.arg('sort_by')::text = 'synced' AND sqlc.arg('sort_dir')::text = 'desc' THEN ri.sync_status END DESC,
  CASE WHEN sqlc.arg('sort_by')::text = 'updated_at' AND sqlc.arg('sort_dir')::text = 'asc' THEN ri.updated_at END ASC,
  CASE WHEN sqlc.arg('sort_by')::text = 'updated_at' AND sqlc.arg('sort_dir')::text = 'desc' THEN ri.updated_at END DESC,
