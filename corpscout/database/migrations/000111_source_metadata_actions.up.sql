...
SET
  ...
  storage_kind = COALESCE(NULLIF(storage_kind, ''), 'clickhouse'),
  clickhouse_database = COALESCE(clickhouse_database, 'corpscout'),
...
SET
  ...
  input_table_name = 'corpscout.fi_prhytj_*',
  country = 'finland',
  source = 'prhytj',
...
SET
  ...
  source_group = 'registry',
  input_table_name = 'corpscout.us_coloradoentities_*',
...
VALUES
  ...
  (
    ...
    'registry',
    'corpscout.us_coloradoentities_*',
    'united_states',
    'coloradoentities',
