...
SELECT
  ...
  company.updated_at,
  CASE
    WHEN latest_financial.company_id IS NOT NULL THEN 'success'
    WHEN process_status.financial_status = 'skipped' THEN 'skipped'
    ELSE 'unknown'
...
CREATE INDEX idx_brreg_source_mv_company_explorer_financial_status_updated
  ON brreg_source.mv_company_explorer(financial_status, updated_at DESC, organization_number ASC);
