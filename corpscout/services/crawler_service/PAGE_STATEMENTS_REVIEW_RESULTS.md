...
[statement_prompts.py](src/crawler_service/statement_prompts.py), description review
in [statement_review.py](src/crawler_service/statement_review.py), and normalization
in [statements.py](src/crawler_service/statements.py).
...
`uvx ty check crawler_service` reports 19 diagnostics in benchmark scripts and tests;
