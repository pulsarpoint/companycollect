...
from crawler_service.external_links import assess_external_links
...
from crawler_service.prompts import extraction_prompt
...
async def research_company(
    ...
    *,
    ...
    root = (
        ...
        else Path("crawler-service-output") / uuid4().hex
    ).resolve()
