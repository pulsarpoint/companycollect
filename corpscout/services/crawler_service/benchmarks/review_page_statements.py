...
from crawler_service.statement_review import accepted_description
from crawler_service.statements import consolidate_page_statements
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--snapshot",
        type=Path,
        default=Path("data/novelic-page-statements-v1-recovered"),
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("data/novelic-page-statements-v2"),
    )
