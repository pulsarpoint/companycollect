...
from crawler_service.models import ResearchResult, validate_specific_technology_name
from crawler_service.profiles import summarize_company
from crawler_service.research import update_statuses
from crawler_service.review import REVIEW_OBJECTIVES, review_claims, review_proposals
...
async def run(args):
    ...
    source = Path(__file__).parents[1] / "src" / "crawler_service"
    shutil.copytree(
        source,
