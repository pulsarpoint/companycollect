> Historical design, archived 16 September 2026. This is outside the active
> crawler scope and is not an implementation instruction. See the
...
flowchart TD
    ...
    Research[Crawler service JSON and source artifacts] --> Resolve
...
| Extractor schema | [Models](../src/crawler_service/models.py), [prompts](../src/crawler_service/prompts.py); source-faithful applicability and explicit schema versioning if changed |
| Local preview | [Analytics](../src/crawler_service/analytics.py); keep preview semantics distinct from database resolution |
