...
from crawler_service import ResearchConfig
from crawler_service.models import OBJECTIVES, RECORD_TYPES
    ...
    async def run_browser_flow(
        ...
        try:
            with (
                ...
                patch("crawler_service.research.open_browser", tracked_browser),
            ):
                root = Path(directory)
