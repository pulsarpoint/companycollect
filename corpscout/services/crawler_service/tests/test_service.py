...
from crawler_service.crawl import main
from crawler_service.service import CrawlRequest, CrawlService, ServiceUnavailable
...
class CrawlServiceTests(unittest.IsolatedAsyncioTestCase):
    def setUp(self):
        ...
        self.browser_patch = patch("crawler_service.crawl.open_browser", browser)
    ...
    async def test_execution_error_produces_terminal_local_json(self):
        ...
        try:
            with patch(
                "crawler_service.service.crawl_company",
