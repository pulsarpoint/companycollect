...
from company_research.service_cli import main
    ...
    def test_s3_environment_and_flag_override(self):
        with TemporaryDirectory() as temporary:
            ...
            with (
                ...
                patch("company_research.service_cli.create_app", capture),
                patch("company_research.service_cli.uvicorn.run") as run,
            ):
                main()
    ...
    def test_health_needs_no_broker(self):
        with TemporaryDirectory() as temporary:
            ...
            with (
                ...
                patch(
                    "sys.argv",
                    ["company-research-service", "--output-dir", temporary],
                ),
                patch(
                    "company_research.service_cli.uvicorn.run",
