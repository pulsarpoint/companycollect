...
The Ansible deployment enables it with `company_research_challenge_agent_enabled`.
...
Ansible exposes `company_research_challenge_agent_max_runs`. The same requested
