"""Pure HTML-to-JSON parser for rendered Ratsit company pages.

Keep browser and storage concerns outside this module so saved diagnostic HTML can be
reparsed without launching another browser.
"""
