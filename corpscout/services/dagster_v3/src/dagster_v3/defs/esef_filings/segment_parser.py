...
from dagster_v3.defs.esef_filings.report_package import (
    MAX_PACKAGE_FILES,  # noqa: F401 - re-exported, callers still use segment_parser.MAX_PACKAGE_FILES
    MAX_PACKAGE_MEMBER_BYTES,  # noqa: F401 - re-exported, see above
    MAX_PACKAGE_UNCOMPRESSED_BYTES,  # noqa: F401 - re-exported, see above
    contains_inline_xbrl_namespace as _contains_inline_xbrl_namespace,  # noqa: F401 - re-exported, see above
