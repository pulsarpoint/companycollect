...
@dg.asset(
    ...
    description="Add full-crawl domains selected by source IDs or column filters. Existing settings are preserved; the selection is frozen under a task_id.",
)
def website_full_crawl_requests(
    ...
    return seed_crawl_inputs(
        context, config, clickhouse, processing, "corpscout.website_full_crawl_requests"
    )
...
@dg.asset(
    ...
    description="Add jobs-crawl domains selected by source IDs or column filters. Existing settings are preserved; the selection is frozen under a task_id.",
)
def website_jobs_crawl_requests(
    ...
    return seed_crawl_inputs(
        context, config, clickhouse, processing, "corpscout.website_jobs_crawl_requests"
    )
...
@dg.asset(
    ...
    description="Add basic-info domains selected by source IDs or column filters. Existing settings are preserved; the selection is frozen under a task_id.",
)
def website_site_info_requests(
    ...
    return seed_crawl_inputs(
        context, config, clickhouse, processing, "corpscout.website_site_info_requests"
    )
