...
# The identity resolve. Deliberately NOT company_listings: that view adds
...
#
# Every country with an identity rule is resolved in one pass — the rule set is
# what limits coverage, not this query.
