...
text and enqueues it to the Go translator service) and the canonical-domain
derivation (``norway_brreg_clickhouse_canonical_contacts`` derives domains from
corpscout.no_websites after complete contacts have been published). The daily
updates job owns the recurring schedule.
"""

import dagster as dg

# Manual full entity snapshot. The translation loader and canonical-domain
...
# canonical-domain derivation run at the end of this job as well
