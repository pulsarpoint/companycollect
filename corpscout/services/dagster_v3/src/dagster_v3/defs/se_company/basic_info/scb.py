...
def scb_select_sql() -> str:
    return (
        ...
        "    multiIf(source_status_code = '1', 'active', source_status_code = '0', 'never', source_status_code = '9', 'ceased', NULL) AS economic_activity,\n"
...
se_basic_info_suggestions_scb = define_suggestion_asset(
    ...
    description=(
        ...
        "FtgStat mapped to active/inactive and, as economic_activity, to active/never/ceased (slice 6), registration date. Written only when the register "
