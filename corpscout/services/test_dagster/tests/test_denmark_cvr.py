...
from test_dagster.defs.denmark_cvr.assets import (
    DENMARK_CVR_BUCKET,
...
from test_dagster.defs.denmark_cvr.models import (
    CompanySearchResult,
    PersonSearchResult,
    ProductionUnitSearchResult,
    SearchResponse,
)
from test_dagster.defs.denmark_cvr.resources import (
...
def test_denmark_cvr_definitions_register_one_asset_and_no_schedule() -> None:
    from test_dagster.defs.denmark_cvr.assets import defs
    from test_dagster.definitions import defs as load_defs
    ...
    assert set(defs.resources) == {"denmark_cvr_search", "object_store"}
