...
const [saved]=JSON.parse(readFileSync('output/redirect-deployment-20260921/original-runs.json','utf8'));
...
writeFileSync('output/redirect-deployment-20260921/termination.json',JSON.stringify(response,null,2));
