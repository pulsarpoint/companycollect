...
export default [
  ...
  route("admin", "routes/admin-layout.tsx", [
    ...
    route("brave/queue-submissions/:runId", "routes/admin-brave-queue-submission.ts"),
    route("brave/retry-failed", "routes/admin-brave-retry-failed.ts"),
    route("brave/company-sources", "routes/admin-brave-company-sources.ts"),
    route("brave/search-options", "routes/admin-brave-search-options.ts"),
